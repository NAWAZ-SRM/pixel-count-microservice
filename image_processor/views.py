...
#     frontend_path = os.path.join(settings.BASE_DIR, "frontend", "build", "index.html")
#     if os.path.exists(frontend_path):
#         with open(frontend_path, "r") as file:
#             return HttpResponse(file.read())
#     return HttpResponse("React frontend not found. Build it using 'npm run build'", status=404)
